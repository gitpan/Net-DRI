## Domain Registry Interface, Whois parse for .ORG (RFC3912)
##
...
Net::DRI::Protocol::Whois::Domain::ORG - Whois .ORG parse (RFC3912) for Net::DRI
...
sub info_parse
{
 ...
 Net::DRI::Protocol::Whois::Domain::common::epp_parse_contacts($domain,$rr,$rinfo,{registrant => 'Registrant',admin => 'Admin', tech => 'Tech'},undef);
