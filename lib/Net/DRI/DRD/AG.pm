...
sub verify_name_domain
{
 ...
 my @d=split(/\./,$domain);
 return 13 if substr($d[0],2,2) eq '--'; ## http://www.nic.ag/reserved-names-policy.htm §1
 return 14 if exists($Net::DRI::Util::CCA2{uc($d[0])}); ## http://www.nic.ag/reserved-names-policy.htm §6
 return 15 if ($d[0]=~m/^\d+$/); ## http://www.nic.ag/reserved-names-policy.htm §4
 return 20 if (lc($d[0])=~m/^(?:enum|example|localhost|ns|com|edu|ftp|net|whois|wpad|brand|org|tm|co|nom|ac|bd)$/o); ## §7,8,9,10
