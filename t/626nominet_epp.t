...
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="http://www.nominet.org.uk/epp/xml/nom-domain-1.2" xsi:schemaLocation="http://www.nominet.org.uk/epp/xml/nom-domain-1.2 nom-domain-1.2.xsd"><domain:name>example.co.uk</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build');
