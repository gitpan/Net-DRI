...
$dri->target('AERO')->new_current_profile('p1','Net::DRI::Transport::Dummy',[{f_send=>\&mysend,f_recv=>\&myrecv}],'Net::DRI::Protocol::EPP::Extensions::AERO',[]);
...
$cs->set($c2,'tech');
$cs->set($c2,'billing');
$rc=$dri->domain_create_only('whatever.aero',{duration=>DateTime::Duration->new(years=>2),ns=>$dri->local_object('hosts')->set(['ns1.example.com'],['ns1.example.net']),contact=>$cs,auth=>{pw=>'2fooBAR'},ens=>{auth_id=>'ENS-C1',auth_key=>'my secret'}});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>whatever.aero</domain:name><domain:period unit="y">2</domain:period><domain:ns><domain:hostObj>ns1.example.com</domain:hostObj><domain:hostObj>ns1.example.net</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="billing">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><aero:create xmlns:aero="urn:afilias:params:xml:ns:ext:aero-1.0" xsi:schemaLocation="urn:afilias:params:xml:ns:ext:aero-1.0 aero-1.0.xsd"><aero:ensAuthID>ENS-C1</aero:ensAuthID><aero:ensAuthKey>my secret</aero:ensAuthKey></aero:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create_only build');
