...
$dri->target('VNDS')->add_current_test_profile('p1','Dummy',{f_send=>\&mysend,f_recv=>\&myrecv},'epp',['1.0',[],'dotNET']);
...
$dri->target('VNDS')->add_current_test_profile('p2','Dummy',{f_send=>\&mysend,f_recv=>\&myrecv},'epp',['1.0',[],'_auto_']);
...
## you can always pass it explicitely, which will override the default set in add_current_test_profile only for the given call
$dri->target('VNDS')->add_current_test_profile('p3','Dummy',{f_send=>\&mysend,f_recv=>\&myrecv},'epp',['1.0',[],'_auto_']);
