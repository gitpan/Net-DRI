...
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="2846"><qDate>2009-05-05T07:52:47.0Z</qDate><msg>Identification process begins.</msg></msgQ><extension><frnic:ext xmlns:frnic="http://www.afnic.fr/xml/epp/frnic-1.1"><frnic:resData><frnic:idtData><frnic:contact><frnic:id>ET1323</frnic:id><frnic:identificationProcess s="start"/><frnic:legalEntityInfos><frnic:idStatus>deprecated</frnic:idStatus><frnic:legalStatus s="company"/><frnic:siren>123456789</frnic:siren><frnic:VAT>FR1234567890</frnic:VAT><frnic:trademark>27YOUPLA2345678</frnic:trademark></frnic:legalEntityInfos></frnic:contact></frnic:idtData></frnic:resData></frnic:ext></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="2848"><qDate>2009-05-05T07:52:49.0Z</qDate><msg>Identification process finished.</msg></msgQ><extension><frnic:ext xmlns:frnic="http://www.afnic.fr/xml/epp/frnic-1.1"><frnic:resData><frnic:idtData><frnic:contact><frnic:id>ET1323</frnic:id><frnic:identificationProcess s="finished"/><frnic:legalEntityInfos><frnic:idStatus>ok</frnic:idStatus><frnic:legalStatus s="company"/><frnic:trademark>NEW-TRADEMARK-ID</frnic:trademark></frnic:legalEntityInfos></frnic:contact></frnic:idtData></frnic:resData></frnic:ext></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="2849"><qDate>2009-05-05T07:52:50.0Z</qDate><msg>Holder identification prevents DNS announcement.</msg></msgQ><extension><frnic:ext xmlns:frnic="http://www.afnic.fr/xml/epp/frnic-1.1"><frnic:resData><frnic:idtData><frnic:domain><frnic:name>nic.fr</frnic:name><frnic:status s="serverHold"/><frnic:registrant>XXX1234</frnic:registrant></frnic:domain></frnic:idtData></frnic:resData></frnic:ext></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
$msgid=$rc->get_data('message','session','last_id');
