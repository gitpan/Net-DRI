...
is($n->as_string(0),'SUCCESS: Command completed successfully (1000/1000)','epp as_string(0)');
is($n->as_string(1),'SUCCESS: Command completed successfully (1000/1000)','epp as_string(1)');
